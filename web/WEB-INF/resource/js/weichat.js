...
if (ISWP) {
    ...
    if (profile) {
        profile.setAttribute("href", "weixin://profile/gh_7cabdc4756f9");
    }
}
var tid = "";
var aid = "";
var uin = "Mjg3MTA3OTMwMA==";
var key = "";
var biz = "MjM5OTAzMzQyNQ==";
var networkType;
...
(function () {
    ...
    function onBridgeReady() {
        ...
        var appId = '',
            imgUrl = "http://mmbiz.qpic.cn/mmbiz/aXEibOJy3GJXjd2Z5E5yXn8uoWWhljT9ibfrgzqibRWiaEoRg1fBNgsk455h1dKMDnSj83zDHfPSybXmLZ9rGbasPw/0",
            link = "http://mp.weixin.qq.com/s?__biz=MjM5OTAzMzQyNQ==&mid=200184136&idx=2&sn=8eef53a88a56e16e817121a284b4feef#rd",
            title = htmlDecode("刘强东如何从创业家升级到商界领袖？"),
            desc = htmlDecode("领袖世界微信第一生活类账号，点击题目下蓝字领袖世界关注我，说不定哪天会有惊喜哦。您看此文用了分秒《财富》评选"),
            fakeid = "Mjg3MTA3OTMwMA==";
        desc = desc || link;
...
(function () {
    var timeout = null;
    var val = 0;
    var url = "http://mp.weixin.qq.com/s?__biz=MjM5OTAzMzQyNQ==&mid=200184136&idx=2&sn=8eef53a88a56e16e817121a284b4feef#rd".split('?').pop();
    var key = hash(url);
    /*
    ...
    for (var i = 0, l = imageEls.length; i < l; i++) {
        ...
        for (var j = 0; j < entities.length; j++) {
            ...
            if (entity.name == src) {
                ajax({
                    type: "POST",
                    url: "/mp/appmsgpicreport?__biz=MjM5OTAzMzQyNQ==" + "&uin=" + uin + "&key=" + key + "#wechat_redirect",
                    data: obj2query({
                        rnd: Math.random(),
                        uin: uin,
                        version: "620888369",
